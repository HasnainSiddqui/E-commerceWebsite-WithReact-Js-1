...
export let ProductDetail = () =>{
  ...
  let  {addToCart,cartItem, isItemAdded , deleteItem}= useContext(CartItemContext)
   

    let [singleProductDetail , setSingleProductDetail] = useState({});
  ...
  <div className="container px-5 py-5 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <Image style={{width:'500px'}}
        ...
        src={`${singleProductDetail.thumbnail}`}
      />
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mb-4">
          <span className="flex items-center">
            ...
            <span className="text-gray-600 ml-3">{singleProductDetail.rating} Reviews</span>
          </span>
